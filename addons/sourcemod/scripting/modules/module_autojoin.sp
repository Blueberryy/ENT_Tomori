...
ConVar gH_Cvar_Tomori_AutoJoin_Mode;					//AutJoin Mode (0 - Given Team with ConVar, 1 - AutoAssign)
ConVar gH_Cvar_Tomori_AutoJoin_Team;					//Team to join automatically (1 - Spectator, 2 - Terrorist, 3 - Counter-Terrorist)
