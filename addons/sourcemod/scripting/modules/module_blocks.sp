...
ConVar gH_Cvar_Tomori_Blocks_Friendlyfire;				//Enable or disable block friendlyfire announce (0 - Original, 1 - Custom, 2 - Block both)
ConVar gH_Cvar_Tomori_Blocks_TeamChange;				//Enable or disable block teamchange announce (0 - Original, 1 - Custom, 2 - Block both)
ConVar gH_Cvar_Tomori_Blocks_Connect;					//Enable or disable block connect announce (0 - Original, 1 - Custom, 2 - Block both)
ConVar gH_Cvar_Tomori_Blocks_Disconnect;				//Enable or disable block disconnect announce (0 - Original, 1 - Custom, 2 - Block both)
ConVar gH_Cvar_Tomori_Blocks_Cash;						//Enable or disable block cvarchange announce (0 - Enable, 1 - Disable)
ConVar gH_Cvar_Tomori_Blocks_Radio;						//Enable or disable block cvarchange announce (0 - Enable, 1 - Disable)
ConVar gH_Cvar_Tomori_Blocks_SavedPlayer;				//Enable or disable block cvarchange announce (0 - Enable, 1 - Disable)

ConVar gH_Cvar_Tomori_Blocks_Status;					//Enable or disable block status in console (0 - Enable, 1 - Disable)
ConVar gH_Cvar_Tomori_Blocks_Ping;						//Enable or disable block ping in console (0 - Enable, 1 - Disable)
		...
		if(!event.GetBool("disconnect"))
		{
			...
			if (gH_Cvar_Tomori_Blocks_Enabled.BoolValue)
			{
				...
				else if (gH_Cvar_Tomori_Blocks_TeamChange.IntValue == 1)
				{
					...
					else if (event.GetInt("team") == CS_TEAM_SPECTATOR) Format(TeamName, sizeof(TeamName), "%t", "Tomori Spectator");
