...
ConVar gH_Cvar_Tomori_Purge_Days;					//Amount of days to purge after
ConVar gH_Cvar_Tomori_Purge_Logging;				//Enable or disable Purge logging (0 - Disable, 1 - Enabled)
...
public void Purge_OnPluginStart()
{
	...
	DirExistsEx(Folder);
	SetLogFile(gShadow_Tomori_Purge_LogFile, "Tomori-Purge", "Entity");
